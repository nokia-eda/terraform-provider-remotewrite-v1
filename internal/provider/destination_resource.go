...
const (
	create_rs_destination = "/apps/remotewrite.eda.nokia.com/v1/namespaces/{namespace}/destinations"
	read_rs_destination   = "/apps/remotewrite.eda.nokia.com/v1/namespaces/{namespace}/destinations/{name}"
	update_rs_destination = "/apps/remotewrite.eda.nokia.com/v1/namespaces/{namespace}/destinations/{name}"
	delete_rs_destination = "/apps/remotewrite.eda.nokia.com/v1/namespaces/{namespace}/destinations/{name}"
)
