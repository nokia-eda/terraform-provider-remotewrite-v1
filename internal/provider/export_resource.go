...
const (
	create_rs_export = "/apps/remotewrite.eda.nokia.com/v1/namespaces/{namespace}/exports"
	read_rs_export   = "/apps/remotewrite.eda.nokia.com/v1/namespaces/{namespace}/exports/{name}"
	update_rs_export = "/apps/remotewrite.eda.nokia.com/v1/namespaces/{namespace}/exports/{name}"
	delete_rs_export = "/apps/remotewrite.eda.nokia.com/v1/namespaces/{namespace}/exports/{name}"
)
